  ...
  return (
    <div style={{ maxWidth: '400px', margin: '0 auto', padding: '1rem', }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" style={{ padding: '.5rem 1rem', cursor: 'pointer',color:"black" }}>Login</button>
      </form>
      <a href="/register">
      <button  style={{ padding: '.5rem 1rem', cursor: 'pointer',color:"black" }}>create Account</button>
      </a>
    </div>
  );
};
